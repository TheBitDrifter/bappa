...
require github.com/TheBitDrifter/bappa/blueprint v0.0.0-00010101000000-000000000000

require (
	github.com/TheBitDrifter/bappa/table v0.0.0-20250315162738-9d26b0df5cd1 // indirect
