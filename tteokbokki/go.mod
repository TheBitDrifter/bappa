...
require (
	github.com/TheBitDrifter/bappa/blueprint v0.0.0-20250330212722-f989bbd448b4
	github.com/TheBitDrifter/bappa/warehouse v0.0.0-20250330212722-f989bbd448b4
)

require (
	github.com/TheBitDrifter/bappa/table v0.0.0-20250330195601-61b1a350228f // indirect
